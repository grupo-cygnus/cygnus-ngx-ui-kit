export const TW_CLASS = {
  ...
  BTN_SECONDARY: 'text-gray-700 dark:text-gray-400 bg-gray-25 dark:bg-gray-800 border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-300 hover:border-gray-300 focus:ring-gray-300',
  ...
  BTN_GREEN: 'text-white bg-green-600 border-transparent hover:bg-green-700 focus:bg-green-600 focus:ring-green-300 hover:border-transparent',
  ...
  BTN_BLUE_VIOLET: 'border-transparent text-white bg-blue-violet-600 hover:bg-blue-violet-700 focus:bg-blue-violet-700 focus:ring-blue-violet-300 hover:border-transparent',
  ...
  BTN_PRIMARY_CYGNUS: 'border-transparent text-white bg-primary-cygnus-400 hover:bg-primary-cygnus-500 focus:bg-primary-cygnus-500 focus:ring-primary-cygnus-300 hover:border-transparent',
  ...
  BTN_GHOST_GRAY: 'text-gray-600 bg-transparent border-transparent !shadow-none hover:bg-gray-200 hover:border-gray-800/5 !hover:shadow-none focus:ring-blue-300 focus:border-gray-800 transition-all disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none',
  BTN_OUTLINED: 'border-blue-700 text-blue-700 hover:bg-blue-800 hover:text-blue-50 hover:shadow-md focus:ring-blue-300',
  BTN_OUTLINED_RED: 'border-red-700 text-red-700 hover:bg-red-700 hover:text-red-50 hover:shadow-md focus:ring-red-300',
  BTN_OUTLINED_GREEN: 'border-green-700 text-green-700 hover:bg-green-700 hover:text-green-50 hover:shadow-md focus:ring-green-300',
  BTN_OUTLINED_AMBER: 'border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-amber-50 hover:shadow-md focus:ring-amber-300',
  BTN_OUTLINED_GRAY: 'border-gray-700 text-gray-700 hover:bg-gray-700 hover:text-gray-50 hover:shadow-md focus:ring-gray-300',
  BTN_OUTLINED_CYGNUS: 'border-cygnus-500 text-cygnus-500 hover:bg-cygnus-500 hover:text-cygnus-50 hover:shadow-md focus:ring-cygnus-500',
